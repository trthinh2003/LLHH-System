                ...
                <ul class="sidebar-nav mx-0">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="options" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item">
                                <a href="#" class="sidebar-link">Đăng ký lịch thực hành</a>
                            </li>
                            <li class="sidebar-item">
                                ...
                                <div class="card-body p-0 d-flex flex-fill">
                                    <div class="row g-0 w-100">
                                        <div class="col-3 align-self-start text-start">
                                            <img src="assets/images/sys-avatar.png" class="img-fluid illustration-img" alt="">
                                        </div>
                        ...
                        <div class="col-12 col-md-6 d-flex">
                            <div class="card flex-fill border-0 illustration">
                                <div class="card-body p-0 d-flex flex-fill">
                                    <div class="row g-0 w-100">
                                        <div class="col-3 align-self-start text-start">
                                            <img src="assets/images/view.png" class="img-fluid illustration-img" alt="">
                                        </div>
                                        <div class="col-9 text-start">
                                            <div class="p-2 m-1">
